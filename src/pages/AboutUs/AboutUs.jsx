      ...
      <section className='main-us'>
        <article className='main-us-article'>
          ...
          <div className='main-us-article-container'>
            <p>
              Somos una empresa parte de <b style={{ color: '#01274d' }}>Grupo Taraborelli</b> con más de 35 años de historia, las más importantes marcas del mercado confían en nosotros es por eso que
              somos Concesionario Oficial New Holland , contamos con un equipo de profesionales, con un fuerte Dinamismo y gran adaptabilidad a las circunstancias de mercado y siempre orientado al
              cliente para brindar soluciones personalizadas.
            </p>
            <br></br>
