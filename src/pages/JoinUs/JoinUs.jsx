    ...
    <main className='join'>
      <section className='join-info'>
        <article className='join-info-article'>
          ...
          <p>
            ¡Bienvenido a <b style={{ color: '#01274d' }}>Taraborelli Agro!</b> Estamos emocionados de que estés considerando unirte a nosotros para experimentar el mundo innovador de la maquinaria
            agrícola de vanguardia. Al sumarte a nuestra comunidad, te convertirás en parte de una red apasionada de agricultores y profesionales comprometidos con la excelencia en el campo.
          </p>
          <br></br>
          <p>
            No te pierdas la oportunidad de formar parte de nuestra comunidad en constante crecimiento. Ingresa tu cv ahora y únete a nosotros en el emocionante viaje hacia un futuro agrícola más
            eficiente, sostenible y exitoso. ¡Estamos ansiosos por tenerte a bordo!
          </p>
          ...
          <form className='join-info-article-form'>
            ...
            <textarea id='mensaje' className='join-info-article-form-textarea' placeholder='Mensaje'></textarea>
            <label
              style={{
            ...
            >
              CV
              <input type='file' id='file-input' style={{ display: 'none' }} onChange={showFileName} />
            </label>
            <br></br>
            <p id='file-name' style={{ marginBottom: 0, textAlign: 'start', marginLeft: 10 }}></p>

            <button onClick={() => sendForm()} className='join-info-article-form-button' type='button'>
              ENVIAR
            </button>
          </form>
        </article>
